  ...
  return (
    <>
      ...
      <p>
        ...
        . <strong>Вода</strong> — модель 30–35{NN}мл/кг в сутки как практический
        ориентир; см.{" "}
        <a
      ...
      <p>
        ...
        веществ может отличаться от формульного на ±10–15{NN}%. Формулы
        разработаны для здоровых взрослых и{NB}не применимы напрямую при:
      </p>
      <ul>
