 ...
 * - `lastTdee`: норма на день для блока «темп похудения» (сопоставление доли дефицита).
 *
...
type Ctx = {
  ...
  lastHeight: string;
  lastWeight: string;
  /** Норма на день из последнего успешного расчёта блока калорий; для оценки доли дефицита. */
